...
class VerifyResponse(BaseModel):
    result: int = Field(..., description="Gateway response status code. 100 means success.")
    ...
    status: int | None = Field(None, description="Bank transaction status (1: success, 2: canceled)")
    ...
    multiplexing_infos: MultiplexingInfo | None = None
