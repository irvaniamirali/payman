...
def main():
    ...
    payment_response = pay.payment(payment_data)
    ...
    time.sleep(10)  # simulate user payment delay
    ...
    if callback_data.success == 1:
        verify_response = pay.verify(PaymentVerifyRequest(track_id=callback_data.track_id))
